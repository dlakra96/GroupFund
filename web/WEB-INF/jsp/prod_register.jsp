<%-- 
    Document   : prod_register
    Created on : 14 Aug, 2016, 1:48:15 PM
    Author     : Deepanshu
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="well">
                <form:form method="post" action="AddProd" modelAttribute="product">
            <table class="table table-bordered">
            
                 <tr>
            <td>
                <form:label path="pid">Enter Product/Service code </form:label>
            </td>
            <td>
            <form:input path="pid" />
                ...
                <tr>
            <td>
                <form:label path="pname">Enter Product/Service name </form:label>
            </td>
            <td>
            ...
            <tr>
<td>
    <form:label path="description">Enter Product/Service description</form:label>
</td>
<td>
