<%-- 
    Document   : desk_delete
    Created on : 14 Aug, 2016, 12:48:03 PM
    Author     : Deepanshu
--%>
...
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <body>
        ...
        <div class="container">
            <div class="well">
        <form:form method="post" action="DelServ" commandName="desk">
            <table class="table table-bordered">
            <tr>
            <td>
                <form:label path="number">Enter Service desk number which you want to delete </form:label>
            </td>
            <td>
