<%-- 
    Document   : bankO_delete
    Created on : 10 Aug, 2016, 6:12:58 PM
    Author     : Deepanshu
--%>
...
<spring:url value="/Resources/bootstrap.min.css" var="bootCSS"/>
    ...
    <body>
        ...
        <div class="container">
            <div class="well">
        <form:form method="post" action="deleteOfficer" commandName="officer">
            <table class="table table-bordered">
            <tr>
            <td>
                <form:label path="id">Enter Banking Officer's ID whose record you want to delete from database</form:label>
            </td>
            <td>
            <form:input path="id" />
