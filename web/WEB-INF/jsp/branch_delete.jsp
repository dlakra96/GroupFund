<%-- 
    Document   : branch_delete
    Created on : 12 Aug, 2016, 2:43:33 PM
    Author     : Deepanshu
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            <div class="well">
        <form:form method="post" action="DelBranch" commandName="branch">
            <table class="table table-bordered">
            <tr>
            <td>
                <form:label path="code">Enter Branch Code which you want to delete</form:label>
            </td>
            <td>
